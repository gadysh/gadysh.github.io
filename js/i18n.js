...
export const strings = {
  en: {
    ...
    // People & capability layer
    'team.title': 'The people and capabilities behind PowOrg',
    'team.subtitle': 'A human founder holds real-world authority. Stable names make the professional capability layer easier to know and work with.',
    'team.gadi.name': 'Gadi',
    'team.gadi.role': 'Founder & human authority',
    'team.gadi.bio': 'Sets direction and retains the decisions that must stay human: money, publication, external commitments, deletion and judgment outside known policy.',
    'team.poppy.name': 'Poppy',
    'team.poppy.role': 'Strategy & coordination',
    'team.poppy.bio': 'Turns direction into priorities, decisions and a coherent operating picture across the company.',
    'team.dave.name': 'Dave',
    'team.dave.role': 'Engineering capability',
    'team.dave.bio': 'Owns architecture, integrations, infrastructure and production-grade technical delivery.',
    'team.mark.name': 'Mark',
    'team.mark.role': 'Marketing capability',
    'team.mark.bio': 'Translates verified work into clear public language, evidence and useful market communication.',
    'team.maya.name': 'Maya',
    'team.maya.role': 'People & operations capability',
    'team.maya.bio': 'Shapes roles, onboarding and the operating practices that let the organization improve safely.',
    'team.disclosure': 'Poppy, Dave, Mark and Maya are presentation aliases — not separate employees or fixed system identities. The underlying professional capabilities are loaded according to the work.',
  ...
  he: {
    ...
    'team.title': 'האנשים והיכולות שמאחורי PowOrg',
    'team.subtitle': 'מייסד אנושי מחזיק בסמכות בעולם האמיתי. שמות יציבים הופכים את שכבת היכולות המקצועיות לקלה יותר להיכרות ולעבודה.',
    'team.gadi.name': 'גדי',
    'team.gadi.role': 'מייסד וסמכות אנושית',
    'team.gadi.bio': 'קובע כיוון ומחזיק בהחלטות שחייבות להישאר אנושיות: כסף, פרסום, התחייבויות חיצוניות, מחיקה ושיקול דעת מחוץ למדיניות הקיימת.',
    'team.poppy.name': 'פופי',
    'team.poppy.role': 'אסטרטגיה ותיאום',
    'team.poppy.bio': 'מתרגמת כיוון לסדרי עדיפויות, החלטות ותמונת הפעלה אחת וברורה לכל החברה.',
    'team.dave.name': 'דייב',
    'team.dave.role': 'יכולת הנדסית',
    'team.dave.bio': 'אחראי על ארכיטקטורה, אינטגרציות, תשתיות ומסירה טכנולוגית ברמת ייצור.',
    'team.mark.name': 'מארק',
    'team.mark.role': 'יכולת שיווקית',
    'team.mark.bio': 'מתרגם עבודה מאומתת לשפה ציבורית ברורה, לראיות ולתקשורת שוק שימושית.',
    'team.maya.name': 'מאיה',
    'team.maya.role': 'יכולת אנשים ותפעול',
    'team.maya.bio': 'מעצבת תפקידים, קליטה ושיטות עבודה שמאפשרות לארגון להשתפר בבטחה.',
    'team.disclosure': 'פופי, דייב, מארק ומאיה הם שמות־הצגה — לא עובדים נפרדים ולא זהויות מערכת קבועות. היכולות המקצועיות שמאחוריהם נטענות לפי העבודה.',
